...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 shadow-lg transition-all duration-300 rounded-full overflow-hidden"
      style={{
    ...
    >
      {/* WhatsApp SVG icon */}
      <div className="p-3 flex items-center justify-center flex-shrink-0">
        <svg
          viewBox="0 0 24 24"
          className="h-5 w-5"
          fill="white"
